...
- [x] **Step 1.1: Replace async spawn with awaited blocking speaker verification**
  - File(s): src/main.rs
...
- [x] **Step 1.2: Move mode-change side effects into synchronous code**
  - File(s): src/main.rs
...
- [x] **Step 1.3: Restructure SpeechEnd handling to support .await**
  - File(s): src/main.rs
...
- [x] **Step 2.1: Rewrite Ambient-mode response gating**
  - File(s): src/main.rs
...
- [x] **Step 2.2: Handle AmbientLocked distinction**
  - File(s): src/main.rs
...
- [x] **Step 2.3: Update the ConversationMode doc comments**
...
- [x] **Step 3.1: Discard non-main-user speech in Active mode**
  - File(s): src/main.rs
...
- [x] **Step 4.1: Update existing ambient E2E tests**
...
- [x] **Step 4.2: Add E2E test for main-user wake word switching to Active**
  - File(s): src/e2e_tests.rs
...
- [x] **Step 4.3: Add E2E test for secondary voice + wake word staying in Ambient**
  - File(s): src/e2e_tests.rs
...
- [x] **Step 4.4: Add E2E test for non-main user in Active mode**
  - File(s): src/e2e_tests.rs
...
- [x] **Step 5.1: Update doc/MAIN_PROCESS.md state machine diagram**
...
- [x] **Step 5.2: Review doc/doc.md for contradictions**
  - File(s): doc/doc.md
...
- [x] **Step 6.2: Manual review of transition table**
