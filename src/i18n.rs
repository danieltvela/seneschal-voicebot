pub fn get_notification(key: &str, lang: &str) -> &'static str {
    match (key, lang) {
        ("first_launch", "es") => {
            ...
            1. QUIÉN ERES: Eres Jarvis, el mayordomo digital. Has estado programado para ayudarle con todo lo que necesite mediante voz.\n\n\
        ...
        ("first_launch", "en") => {
            ...
            1. WHO YOU ARE: You are Jarvis, the digital butler. You were built to help him with anything he needs through voice.\n\n\
